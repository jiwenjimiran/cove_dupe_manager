...
The package is written to `artifacts\io.github.jiwenjimiran.duplicate-manager-1.9.2.zip`.
...
3. Paste the direct URL for `io.github.jiwenjimiran.duplicate-manager-1.9.2.zip` from the GitHub release.
